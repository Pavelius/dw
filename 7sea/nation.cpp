...
static struct nation_i {
	...
	const char*		text;
} nation_data[] = {{"Avalon", "Авалон", Resolve, Glamour, Donowan, "Зеленая и зачарованная земля. Представляет собой союз трех королевств, недавно появившийся на горизонте тэйянской политики."},
