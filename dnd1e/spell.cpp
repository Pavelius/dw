...
static struct spell {
	...
	{"Cure Light Wounds", "Лечить легкое ранение", {Necromantic}, {1}, Touch, Instantaneous, {}, TargetAlly, HealingPower},
...
bsreq spell_type[] = {
	BSREQ(spell, id, text_type),
	BSREQ(spell, name, text_type),
	BSREQ(spell, levels, number_type),
	{}
};
