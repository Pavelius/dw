...
static int selectnames(short unsigned* elements, class_s type, race_s* race, gender_s gender)
{
	...
	{
		if(gender != Transgender && name_data[i].gender != gender)
			continue;
