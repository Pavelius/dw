...
static item_s armor_items[] = {
	BandedMail, Brigandine,
	ChainMail, ChainMail, ChainMail,
	FieldPlate, FullPlate, LeatherArmor,
	PlateMail, PlateMail, PlateMail, PlateMail,
	RingMail, ScaleMail,
...
bsreq magic_item_type[] = {
	BSREQ(magic_item, id),
	BSREQ(magic_item, name),
	BSREQ(magic_item, type),
{}}; BSMETA(magic_item);
