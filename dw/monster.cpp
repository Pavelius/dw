...
static mastermove kobold_moves[] = {
	...
	{"Мерзкий ящерообразный кобольд подудел в дудочку. При это вы увидели как один или несколько кобольдов добавились к битве.", Summon, {1, 3}},
};
static mastermove goblin_moves[] = {
	{"\n- Здесь еда!!! Все сюда!! - заорал один гоблин, скаля мерзкую улыбку.\nИз темного прохода выскочили еще [%1i] гоблинов.", Summon, {1, 2, 1}},
