...
static struct spell_i {
	...
	{"Cause fear", "Вызвать страх", {-1, 1}, Self, true, {}, "Ваша фигура озарилась темным светом."},
	{"Contact Spirits", "Вызов духов", {1, -1}},
	{"Cure Light Wounds", "Лечить легкие ранения", {-1, 1}, Hero, false, {1, 8}, "%герой озарился белым светом."},
	{"Detect Alignment", "Определить мировозрение", {-1, 1}},
	...
	{"Magic Weapon", "Волшебное оружие", {-1, 1}, Self, false},
	{"Sanctuary", "Убежище", {1, -1}, Self, false},
	{"Speak with Dead", "Разговор с мертвецами", {-1, 1}, Self, false},
	{"Alarm", "Тревога", {1, -1}},
	//
