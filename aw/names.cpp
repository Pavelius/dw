...
static struct nameinfo {
	...
	{TheAngel, Transgender, "Bish", "Облом"},
	...
	{TheBattleBaby, Transgender, "Midnight", "Полночь"},
	...
	{TheBattleBaby, Transgender, "Kite", "Коршун"},
	...
	{TheGunlugger, Transgender, "Fido", "Фидо"},
	{TheGunlugger, Transgender, "Spot", "Спот"},
	{TheGunlugger, Male, "Boxer", "Боксер"},
	{TheGunlugger, Transgender, "Doberman", "Доберман"},
	...
	{TheGunlugger, Transgender, "Rover", "Бита"},
